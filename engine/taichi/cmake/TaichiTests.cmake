...
# Exercise the LLVM allocator directly, without linking a second copy of its
# runtime symbols into taichi_core. The harness uses POSIX aligned allocation.
if(TI_WITH_LLVM AND UNIX AND NOT ANDROID)
    find_package(Threads REQUIRED)
    add_executable(taichi_list_manager_tests tests/runtime/list_manager_test.cpp)
    target_include_directories(taichi_list_manager_tests PRIVATE ${PROJECT_SOURCE_DIR})
    target_compile_definitions(taichi_list_manager_tests PRIVATE ARCH_${HOST_ARCH})
    target_link_libraries(taichi_list_manager_tests PRIVATE Threads::Threads)
endif()
