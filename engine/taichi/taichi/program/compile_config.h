...
struct CompileConfig {
  ...
  // LLVM backend options. Capacities are fixed when the runtime starts.
  int llvm_snode_capacity{1024};
  int llvm_snode_tree_capacity{512};
  ...
  // Called by native runtime loaders; Python handles its own init overrides.
  void apply_llvm_runtime_environment();
};
