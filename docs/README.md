...
- **[address-encoding-transition.md](address-encoding-transition.md)** —
  ...
  storage-key ordering decision (pair codes) and implementation status; the
  codec is converted, the record tier stores the letter subset until the
  pair-code storage step.
